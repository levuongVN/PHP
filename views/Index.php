                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown">
                            <a href="#" class="d-flex align-items-center text-decoration-none dropdown-toggle" data-bs-toggle="dropdown">
                                <img src="https://ui-avatars.com/api/?name=Nguyen+Van+A&background=4361ee&color=fff" class="user-avatar me-2">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="stats-card income">
                            <div class="stats-number text-success">12.450.000 ₫</div>
                    ...
                    <div class="col-md-3">
                        <div class="stats-card expense">
                            <div class="stats-number text-danger">8.750.000 ₫</div>
                    ...
                    <div class="col-md-3">
                        <div class="stats-card balance">
                            <div class="stats-number text-warning">3.700.000 ₫</div>
                    ...
                    <div class="col-md-3">
                        <div class="stats-card">
                            ...
                            <div class="stats-title">Ngân sách đã sử dụng</div>
